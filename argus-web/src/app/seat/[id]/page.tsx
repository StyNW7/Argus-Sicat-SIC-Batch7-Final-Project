    ...
    <div className="min-h-screen p-6 bg-gray-50">
      <div className="max-w-3xl mx-auto bg-white p-6 rounded shadow">
        ...
        <h2 className="text-2xl font-semibold mb-2">
          Seat #{seat.seat_number} — {seat.class_code}
        </h2>
        <div className="mb-4">
          <div>
          ...
          <div>
            <strong>Student:</strong> {seat.student_name || "Kosong"}
          </div>
          <div>
            <strong>NIM:</strong> {seat.student_nim || "-"}
          </div>
          <div>
            <strong>Device ID:</strong> {seat.device_id || "-"}
          </div>
        </div>
          ...
          <div className="space-y-2">
            {history.map((h) => (
              <div key={h.id} className="p-3 border rounded">
                ...
                <div>
                  <strong>Student:</strong> {h.student_name || "-"}
                </div>
                <div>
                  <strong>NIM:</strong> {h.student_nim || "-"}
                </div>
                <div>
                  <strong>Device:</strong> {h.device_id || "-"}
                </div>
