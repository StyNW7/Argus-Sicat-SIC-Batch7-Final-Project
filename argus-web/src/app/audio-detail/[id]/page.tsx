      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white flex items-center justify-center">
        <div className="text-center max-w-md">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-2">
            Audio Event Not Found
          </h3>
          <p className="text-gray-600 mb-6">
            The audio event you&lsquo;re looking for doesn&lsquo;t exist or has
            been removed.
          </p>
          <button
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  Detailed view of audio monitoring event
                </p>
              </div>
            </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Captured during exam monitoring
                    </p>
                  </div>
                </div>
                <div
                  className={`px-4 py-2 rounded-lg ${labelColor.bg} ${labelColor.text} ${labelColor.border} border flex items-center gap-2`}
                >
                    ...
                    <div className="w-full flex items-end justify-center h-20 gap-1">
                      {waveformData.map((height, index) => {
                        ...
                        return (
                          <div
                            key={index}
                            className={`flex-1 rounded-t-lg transition-all duration-150 ${
                              isActive
                    ...
                    <div className="flex items-center gap-4 w-full">
                      ...
                      <div className="relative flex-1">
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-2 relative">
                          <div
                            className="bg-gradient-to-r from-blue-500 to-cyan-500 h-2 rounded-full transition-all duration-150"
                            style={{
                              width: audioDuration
                      ...
                      {/* TOTAL DURATION */}
                      <span className="text-sm text-gray-600 min-w-[48px] text-right">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        AI model confidence in prediction
                      </p>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="p-4 bg-gray-50 rounded-xl">
                    ...
                    <p className="text-gray-700">
                      The audio was classified as{" "}
                      <span className="font-semibold">
                        {event.label.replace("_", " ")}
                      </span>{" "}
                      based on acoustic features.
                      {event.label === "whispering" &&
                        " Low amplitude with high zero-crossing rate detected."}
                      {event.label === "normal_conversation" &&
                        " Normal speech patterns with consistent energy levels."}
                      {event.label === "silence" &&
                        " No significant audio activity detected."}
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="pt-6 border-t border-gray-100">
                  ...
                  <div
                    className={`p-4 rounded-xl ${labelColor.bg} ${labelColor.border} border`}
                  >
                    ...
                    <p className={`text-sm ${labelColor.text} opacity-90`}>
                      {event.label === "silence" &&
                        "Normal exam conditions detected."}
                      {event.label === "whispering" &&
                        "Potential whispering detected. May require monitoring."}
                      {event.label === "normal_conversation" &&
                        "Conversation detected. High risk of cheating."}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="space-y-4">
                <button
                  onClick={() =>
                    router.push(`/teacher-dashboard?exam=${event.exam_id}`)
                  }
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Audio Analysis Detail • Event ID: {event.id.slice(0, 8)}...
              </p>
            </div>
